...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		<?php echo $form->labelEx($modelTDP,'id_tipo'); ?>
		<?php 
			echo $form->dropDownList($modelTDP,'id_tipo',
		  		CHtml::listData($modelTiposP,'id_tipo','tipo'),
		  		array('empty'=>'Selecciona un tipo...','class'=>'form-control')
		  		);
  		?>
		<?php echo $form->error($modelTDP,'id_tipo'); ?>
	</div>
